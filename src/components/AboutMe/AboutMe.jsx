...
const AboutMe = ({data}) => {
  ...
  return (
    <section id="about-me" className="pt-32 px-6 bg-white dark:bg-[#1F2937]">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-center gap-8">
          ...
          <div className="w-12 h-[1px] bg-[#7B61FF] dark:bg-[#8F88FF] translate-y-[-5px]"></div>
            ...
            <div className="flex items-center gap-4">
              ...
              <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="inline-flex flex-row items-center gap-2 px-4 py-2 border border-gray-300 dark:border-gray-700 rounded-md text-gray-700 dark:text-gray-300 hover:border-[#7B61FF] dark:hover:border-[#8F88FF] transition-all">
              <FaGithub size={16}/>
              {content.aboutMe.githubButton}
              </a>

              <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="inline-flex flex-row items-center gap-2 px-4 py-2 border border-gray-300 dark:border-gray-700 rounded-md text-gray-700 dark:text-gray-300 hover:border-[#7B61FF] dark:hover:border-[#8F88FF] transition-all">
              <FaLinkedin size={16} />
